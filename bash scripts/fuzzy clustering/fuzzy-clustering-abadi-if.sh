...
python ground-truth.py -galn galaxy_TNG_490577 -cm abadi -orm if
python ground-truth.py -galn galaxy_TNG_469438 -cm abadi -orm if
python ground-truth.py -galn galaxy_TNG_468064 -cm abadi -orm if
python ground-truth.py -galn galaxy_TNG_420815 -cm abadi -orm if
python ground-truth.py -galn galaxy_TNG_386429 -cm abadi -orm if
python ground-truth.py -galn galaxy_TNG_375401 -cm abadi -orm if
python ground-truth.py -galn galaxy_TNG_389511 -cm abadi -orm if
python ground-truth.py -galn galaxy_TNG_393336 -cm abadi -orm if
python ground-truth.py -galn galaxy_TNG_405000 -cm abadi -orm if
...
python fuzzy-clustering.py -galn galaxy_TNG_490577 -f 1.4 #1.3
python fuzzy-clustering.py -galn galaxy_TNG_469438 -f 1.4 #1.3
python fuzzy-clustering.py -galn galaxy_TNG_468064 -f 1.4 #1.3
python fuzzy-clustering.py -galn galaxy_TNG_420815 -f 1.4 #1.3
python fuzzy-clustering.py -galn galaxy_TNG_405000 -f 1.4 #1.3
python fuzzy-clustering.py -galn galaxy_TNG_386429 -f 1.4 #1.3
python fuzzy-clustering.py -galn galaxy_TNG_375401 -f 1.4 #1.3
python fuzzy-clustering.py -galn galaxy_TNG_389511 -f 1.4 #1.3
python fuzzy-clustering.py -galn galaxy_TNG_393336 -f 1.4 #1.3
