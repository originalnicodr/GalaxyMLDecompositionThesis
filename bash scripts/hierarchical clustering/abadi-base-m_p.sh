...
#python hierarchical-clustering.py -galn galaxy_TNG_611399 -c -p m
...
python hierarchical-clustering.py -galn galaxy_TNG_490577 -c -p m
python hierarchical-clustering.py -galn galaxy_TNG_469438 -c -p m
python hierarchical-clustering.py -galn galaxy_TNG_468064 -c -p m
python hierarchical-clustering.py -galn galaxy_TNG_420815 -c -p m
python hierarchical-clustering.py -galn galaxy_TNG_386429 -c -p m
python hierarchical-clustering.py -galn galaxy_TNG_375401 -c -p m
python hierarchical-clustering.py -galn galaxy_TNG_389511 -c -p m
python hierarchical-clustering.py -galn galaxy_TNG_393336 -c -p m
python hierarchical-clustering.py -galn galaxy_TNG_405000 -c -p m
