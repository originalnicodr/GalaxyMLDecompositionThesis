...
for _, galaxy_dirs, _ in os.walk(directory_name):
    for galaxy_dir in galaxy_dirs:
        for dirpath, _, filenames in os.walk(directory_name+galaxy_dir):
            filenames = [fi for fi in filenames if fi.endswith(".data")]
