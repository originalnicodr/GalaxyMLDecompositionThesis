...
def draw_2d_graph_real_scatterplot(gal, clustering_results, clustering_method, ground_truth_comp, ground_truth_method, label_maps, gal_name, results_path):
    ...
    sns.histplot(x="x", y="y", hue=hue, data=df, ax=axs[0,0], legend=False, alpha=0.7)
    sns.histplot(x="y", y="z", hue=hue, data=df, ax=axs[0,1], legend=False, alpha=0.7)
    sns.histplot(x="x", y="z", hue=hue, data=df, ax=axs[0,2], legend=False, alpha=0.7)
    ...
    if clustering_method == "Clustering Jerarquico":
        ...
        sns.histplot(x="x", y="y", hue=hue, data=df, ax=axs[1,0], legend=False, alpha=0.7, kde=True)
        sns.histplot(x="x", y="z", hue=hue, data=df, ax=axs[1,2], legend=False, alpha=0.7, kde=True)
        ...
        if multiple_sub_methods:
            ...
            sns.histplot(x="x", y="y", hue=hue, data=df, ax=axs[2,0], legend=False, alpha=0.7)
            sns.histplot(x="y", y="z", hue=hue, data=df, ax=axs[2,1], legend=False, alpha=0.7)
            sns.histplot(x="x", y="z", hue=hue, data=df, ax=axs[2,2], legend=False, alpha=0.7)
            ...
            sns.histplot(x="x", y="y", hue=hue, data=df, ax=axs[3,0], legend=False, alpha=0.7)
            sns.histplot(x="y", y="z", hue=hue, data=df, ax=axs[3,1], legend=False, alpha=0.7)
            sns.histplot(x="x", y="z", hue=hue, data=df, ax=axs[3,2], legend=False, alpha=0.7)
            ...
            sns.histplot(x="x", y="y", hue=hue, data=df, ax=axs[4,0], legend=False, alpha=0.7)
            sns.histplot(x="x", y="z", hue=hue, data=df, ax=axs[4,2], legend=False, alpha=0.7)
...
def draw_2d_graph_real_histogram(gal, clustering_results, clustering_method, ground_truth_comp, ground_truth_method, label_maps, gal_name, results_path):
    ...
    sns.histplot(x="x", hue=hue, data=df, ax=axs[0,0], legend=False, alpha=0.7, stat='density')
    sns.histplot(x="y", hue=hue, data=df, ax=axs[0,1], legend=False, alpha=0.7, stat='density')
    sns.histplot(x="z", hue=hue, data=df, ax=axs[0,2], legend=False, alpha=0.7, stat='density')
    ...
    if clustering_method == "Clustering Jerarquico":
        ...
        sns.histplot(x="x", hue=hue, data=df, ax=axs[1,0], legend=False, alpha=0.7, stat='density')
        sns.histplot(x="z", hue=hue, data=df, ax=axs[1,2], legend=False, alpha=0.7, stat='density')
        ...
        if multiple_sub_methods:
            ...
            sns.histplot(x="x", hue=hue, data=df, ax=axs[2,0], legend=False, alpha=0.7, stat='density')
            sns.histplot(x="y", hue=hue, data=df, ax=axs[2,1], legend=False, alpha=0.7, stat='density')
            sns.histplot(x="z", hue=hue, data=df, ax=axs[2,2], legend=False, alpha=0.7, stat='density')
            ...
            sns.histplot(x="x", hue=hue, data=df, ax=axs[3,0], legend=False, alpha=0.7, stat='density')
            sns.histplot(x="y", hue=hue, data=df, ax=axs[3,1], legend=False, alpha=0.7, stat='density')
            sns.histplot(x="z", hue=hue, data=df, ax=axs[3,2], legend=False, alpha=0.7, stat='density')
            ...
            sns.histplot(x="x", hue=hue, data=df, ax=axs[4,0], legend=False, alpha=0.7, stat='density')
            sns.histplot(x="z", hue=hue, data=df, ax=axs[4,2], legend=False, alpha=0.7, stat='density')
...
def draw_2d_graph_circ_scatterplot(gal, clustering_results, clustering_method, ground_truth_comp, ground_truth_method, label_maps, gal_name, results_path):
    ...
    sns.histplot(y="eps", x="eps_r", hue=hue, data=df, ax=axs[0,0], legend=False, alpha=0.7)
    sns.histplot(y="eps_r", x="normalized_star_energy", hue=hue, data=df, ax=axs[0,1], legend=False, alpha=0.7)
    sns.histplot(y="eps", x="normalized_star_energy", hue=hue, data=df, ax=axs[0,2], legend=False, alpha=0.7)
    ...
    if clustering_method == "Clustering Jerarquico":
        ...
        sns.histplot(y="eps", x="eps_r", hue=hue, data=df, ax=axs[1,0], legend=False, alpha=0.7)
        sns.histplot(y="eps", x="normalized_star_energy", hue=hue, data=df, ax=axs[1,2], legend=False, alpha=0.7)
        ...
        if multiple_sub_methods:
            ...
            sns.histplot(y="eps", x="eps_r", hue=hue, data=df, ax=axs[2,0], legend=False, alpha=0.7)
            sns.histplot(y="eps_r", x="normalized_star_energy", hue=hue, data=df, ax=axs[2,1], legend=False, alpha=0.7)
            sns.histplot(y="eps", x="normalized_star_energy", hue=hue, data=df, ax=axs[2,2], legend=False, alpha=0.7)
            ...
            sns.histplot(y="eps", x="eps_r", hue=hue, data=df, ax=axs[3,0], legend=False, alpha=0.7)
            sns.histplot(y="eps_r", x="normalized_star_energy", hue=hue, data=df, ax=axs[3,1], legend=False, alpha=0.7)
            sns.histplot(y="eps", x="normalized_star_energy", hue=hue, data=df, ax=axs[3,2], legend=False, alpha=0.7)
            ...
            sns.histplot(y="eps", x="eps_r", hue=hue, data=df, ax=axs[4,0], legend=False, alpha=0.7)
            sns.histplot(y="eps", x="normalized_star_energy", hue=hue, data=df, ax=axs[4,2], legend=False, alpha=0.7)
...
def draw_2d_graph_circ_histogram(gal, clustering_results, clustering_method, ground_truth_comp, ground_truth_method, label_maps, gal_name, results_path):
    ...
    sns.histplot(x="eps", hue=hue, data=df, ax=axs[0,0], legend=False, alpha=0.7, stat='density')
    sns.histplot(x="eps_r", hue=hue, data=df, ax=axs[0,1], legend=False, alpha=0.7, stat='density')
    sns.histplot(x="normalized_star_energy", hue=hue, data=df, ax=axs[0,2], legend=False, alpha=0.7, stat='density')
    ...
    if clustering_method == "Clustering Jerarquico":
        ...
        sns.histplot(x="eps", hue=hue, data=df, ax=axs[1,0], legend=False, alpha=0.7, stat='density')
        sns.histplot(x="normalized_star_energy", hue=hue, data=df, ax=axs[1,2], legend=False, alpha=0.7, stat='density')
        ...
        if multiple_sub_methods:
            ...
            sns.histplot(x="eps", hue=hue, data=df, ax=axs[2,0], legend=False, alpha=0.7, stat='density')
            sns.histplot(x="eps_r", hue=hue, data=df, ax=axs[2,1], legend=False, alpha=0.7, stat='density')
            sns.histplot(x="normalized_star_energy", hue=hue, data=df, ax=axs[2,2], legend=False, alpha=0.7, stat='density')
            ...
            sns.histplot(x="eps", hue=hue, data=df, ax=axs[3,0], legend=False, alpha=0.7, stat='density')
            sns.histplot(x="eps_r", hue=hue, data=df, ax=axs[3,1], legend=False, alpha=0.7, stat='density')
            sns.histplot(x="normalized_star_energy", hue=hue, data=df, ax=axs[3,2], legend=False, alpha=0.7, stat='density')
            ...
            sns.histplot(x="eps", hue=hue, data=df, ax=axs[4,0], legend=False, alpha=0.7, stat='density')
            sns.histplot(x="normalized_star_energy", hue=hue, data=df, ax=axs[4,2], legend=False, alpha=0.7, stat='density')
