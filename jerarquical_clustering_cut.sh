#!/bin/bash
#python abadi-cut.py -galn galaxy_TNG_490577.h5
#python abadi-cut.py -galn galaxy_TNG_469438.h5
#python abadi-cut.py -galn galaxy_TNG_468064.h5
#python abadi-cut.py -galn galaxy_TNG_420815.h5
#python abadi-cut.py -galn galaxy_TNG_386429.h5
#python abadi-cut.py -galn galaxy_TNG_375401.h5
#python abadi-cut.py -galn galaxy_TNG_389511.h5
#python abadi-cut.py -galn galaxy_TNG_393336.h5
#python abadi-cut.py -galn galaxy_TNG_405000.h5
